...
abstract public class Participant {
	...
	/**
	 * Sets the two components of the participant's velocity.
	 * The speed is in pixels per frame refresh and the direction
	 * is in radians.
	 */
	...
	/**
	 * Accelerates in the direction that the participant is oriented.  Participants
	 * cannot accelerate beyond the speed limit.
	 */
	...
	/**
	 * This should be overridden by any derived class to return a Shape object that
	 * describes the outline of the participant.  The center of the Shape should be
	 * at coordinate (0,0).  The center is the reference used when the Shape is moved
	 * or rotated.  This method is called frequently, so it should be efficient.  The
	 * Shape that is returned will not be modified, so it can be cached.
	 */
	...
	public void move () {
		...
		// If the element has gone sufficiently far out of bounds, move it to the 
	 ...
	 * participant is going to be located after it is transformed.  (This can
	 * be useful for computing the tip of a ship, for example.)
	 */
